  ...
  _createClass(Image, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          svg = _props.svg,
          rest = _objectWithoutProperties(_props, ["className", "src", "alt", "spinnerColor", "svg"]);
      ...
      if (this.state.isLoading) {
        ...
        component = _react2.default.createElement(
          "div",
          _extends({}, rest, {
            className: _style2.default.divSpinner + (className ? " " + className : "")
          }),
          _react2.default.createElement(_Spinner2.default, { color: spinnerColor, className: _style2.default.spinner })
        );
        ...
        component = _react2.default.createElement(
          ...
          _extends({
            ...
            bsStyle: "danger",
            className: _style2.default.alert + (className ? " " + className : "")
          }),
        ...
        component = _react2.default.createElement("image", _extends({ xlinkHref: this.state.image }, { className: className, alt: alt }, rest));
      } else {

        component = _react2.default.createElement("img", _extends({ src: this.state.image }, { className: className, alt: alt }, rest));
      }
